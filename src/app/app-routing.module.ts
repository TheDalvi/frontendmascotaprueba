...
const routes: Routes = [
  ...
  {
    path: 'qr-list',
    loadChildren: () => import('./QR/qr-list/qr-list.module').then( m => m.QrListPageModule)
  },
  {
    path: 'qr-form',
    loadChildren: () => import('./QR/qr-form/qr-form.module').then( m => m.QrFormPageModule)
  },
  {
    path: 'edit-usuario',
    loadChildren: () => import('./Usuario/edit-usuario/edit-usuario.module').then( m => m.EditUsuarioPageModule)
  },
